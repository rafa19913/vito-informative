  ...
  <section id="hero">
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="1200" data-bs-pause="true"> 
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/t1.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Terminales</h2>
              </div>
            </div>
          </div>

          <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/t2.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Terminales</h2>
              </div>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/t3.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Terminales</h2>
              </div>
...
<div class="modal fade bd-example-modal-lg" id="modal-product" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <section id="portfolio" class="section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3 class="section-title">Terminales</h3>
        </header>
      ...
      <div class=" col-lg-12">
          <ul id="portfolio-flters">
            ...
            <li data-filter=".filter-Tableta">Tabletas</li>
            <li data-filter=".filter-RFID">RFID</li>
            <li data-filter=".filter-Almacen">Almacén</li>
          </ul>
        </div>
      </div>
    ...
    <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <?php
            $sql = "SELECT p.*, m.nombre as nombreMarca, c.nombre as nombreCategoria FROM productos p JOIN marcas m on p.id_marca = m.id JOIN categorias c on p.id_categoria = c.id WHERE p.id_categoria_master = 9";
