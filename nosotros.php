    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="2000" data-bs-pause="true" >
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/nosotros.jpg)">
          ...
          <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/nosotros2.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Nosotros</h2>
              </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="assets/img/clientes/merco.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clientes/ceva.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clientes/s-mart.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clientes/bemis.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clientes/mondelez.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clientes/benavides.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clientes/mondi.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clientes/firmenich.png" class="img-fluid" alt=""></div>
          </div>
        </div>
...
<section id="about">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>Nosotros</h3>
          <p>
            Somos una empresa dedicada a ofrecer servicios y soluciones tecnológicas de calidad para la optimización de procesos en Automatización en la cadena de suministros, trazabilidad en producción de inventarios, desarrollo de software y gestión de información en cualquier parte del mundo. 
            <br><br> Somos un equipo de trabajo con
actividad empresarial. Contamos con cobertura en Nuevo
León y Tamaulipas. 
Tenemos mas de 10 años de experiencia
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="about-col">
              ...
              <h2 class="title"><a href="#">Control de acceso</a></h2>
              <p>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="about-col">
              ...
              <h2 class="title"><a href="#">Soporte</a></h2>
              <p>
